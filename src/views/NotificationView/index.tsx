...
import { AileronBold, AileronRegular, AileronSemiBold, CurvedView, TopView } from '../../components'
...
const NotificationView = () => {
  return (
    <>
      <TopView title='Notification' TopViewSideIcon={icons.notificationPlan} containerStyleIcon={styles.BellIcon} />
      <CurvedView>
        <View style={styles.notificationRow}>
          <View style={styles.notificationSelectRow}>
            ...
            <TouchableOpacity style={styles.unreadselectRow}>
              ...
              <Image source={icons.arrowDownNotification} style={styles.unreadArrow}/>
            </TouchableOpacity>
          </View>
