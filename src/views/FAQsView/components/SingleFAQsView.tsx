...
const SingleFAQsView = ({ques, description, isExpanded, index, toggleAccordion}:{
    ques: string;
    description: string;
  ...
  return (
    <TouchableOpacity onPress={() => toggleAccordion(index, false)}>
      <LinearGradient
        colors={COLORS.faqsGradient}
        style={styles.accordion}
      >
        <View style={styles.headerRow}>
          <AileronSemiBold style={styles.title} name={ques} />
          <Image source={isExpanded ? icons.minus : icons.plus} style={styles.icon} />
        </View>
