...
import { AileronRegular, AileronSemiBold, Container, CurvedView, TopView } from '../../components';

const FAQsView = ({faqsData, toggleAccordion}:{
    faqsData: Data[];
  ...
  return (
    <Container>
      ...
      <AileronSemiBold name={'We’ve got answers.'} style={styles.faqsSubHeading} />
    <FlatList
      data={faqsData}
