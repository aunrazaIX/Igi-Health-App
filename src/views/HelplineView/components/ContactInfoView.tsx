...
import { AileronBold, AileronRegular, AileronSemiBold } from '../../../components';
import { icons } from '../../../assets';
import styles from '../styles';
import { ContactInfo } from '../../../viewmodels/useHelplineViewModel';

const ContactInfoView = ({ data }: {
  data: ContactInfo;
}) => {
  return (
    <View style={styles.box}>
      <AileronSemiBold style={styles.title} name="Contact information" />
      <AileronRegular style={styles.subtitle} name="Operations & Customer Services" />
      ...
      <AileronBold style={styles.subHeading}
        name={`Emergency & Panel Hospital Approvals\nTel: ${data?.emergencyTel}`}
      />
      <AileronSemiBold style={styles.subHeading} name={`For Claims Tel: ${data?.claimsTel}`} />
